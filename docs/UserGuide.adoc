...
== Finding a persons by their telephone number: `findPhoneNumber`

Finds persons whose telephone number is the given keywords. +
Format: `findPhoneNumber KEYWORD`


Examples:

* `find 12345678` +
Returns the person's full information.
